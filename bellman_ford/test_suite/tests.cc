...
int main(int argc, char* argv[]) {
    ...
    vector<int> node_lengths = {100000, 250000, 500000, 750000, 100000};
    ...
    for(int i = 1; i < argc; i++)
    {
        ...
        cout << "GPU Bellman-Ford on graph with " << numNodes << " nodes" << " took " << cpu_duration.count() << " seconds.\n";
        cout << "\n";
        ...
        cout << "GPU Bellman-Ford on graph with " << numNodes << " nodes" << " took " << gpu_duration.count() << " seconds.\n";
        cout << "\n";

        if(gpu_result == cpu_result) cout << "Results match.\n";
        else cout << "Results don't match.\n";
    }
    return 0;
}
